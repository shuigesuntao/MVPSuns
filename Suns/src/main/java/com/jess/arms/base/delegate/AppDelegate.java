...
import com.jess.arms.di.component.DaggerSunsComponent;
import com.jess.arms.di.component.SunsComponent;
import com.jess.arms.di.module.SunsModule;
...
public class AppDelegate implements App, AppLifecycles {
    ...
    public void onCreate(Application application) {
        ...
        mSunsComponent.extras().put(ConfigModule.class.getName(), mModules);
        ...
        mComponentCallback = new AppComponentCallbacks(mApplication, mSunsComponent);
    ...
    public SunsComponent getSunsComponent() {
        Preconditions.checkNotNull(mSunsComponent,
                "%s cannot be null,first call %s#onCreate(Application) in %s#onCreate()",
                SunsComponent.class.getName(), getClass().getName(), Application.class.getName());
        return mSunsComponent;
    }
    ...
    private static class AppComponentCallbacks implements ComponentCallbacks2 {
        ...
        public AppComponentCallbacks(Application application, SunsComponent sunsComponent) {
            this.mApplication = application;
            this.mSunsComponent = sunsComponent;
        }
