...
import static com.mercy.suns.integration.AppManager.APP_EXIT;
import static com.mercy.suns.integration.AppManager.KILL_ALL;
import static com.mercy.suns.integration.AppManager.SHOW_SNACKBAR;
...
public class SunsUtils {
    ...
    public static SunsComponent obtainAppComponentFromContext(Context context) {
        Preconditions.checkNotNull(context, "%s cannot be null", Context.class.getName());
        Preconditions.checkState(context.getApplicationContext() instanceof App, "Application does not implements App");
        return ((App) context.getApplicationContext()).getSunsComponent();
    }
