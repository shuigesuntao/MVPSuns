/**
  ...
  */
package com.mercy.suns.http.imageloader.glide;
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        ...
        builder.setDiskCache(new DiskCache.Factory() {
            ...
            public DiskCache build() {
                ...
                return DiskLruCacheWrapper.create(DataHelper.makeDirs(new File(sunsComponent.cacheFile(), "Glide")), IMAGE_DISK_CACHE_MAX_SIZE);
            }
        });
        ...
        BaseImageLoaderStrategy loadImgStrategy = sunsComponent.imageLoader().getLoadImgStrategy();
